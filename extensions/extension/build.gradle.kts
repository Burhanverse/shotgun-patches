...
android {
    ...
    defaultConfig {
        buildConfigField("String", "PATCH_AUTHOR", "\"Xie\"")
        buildConfigField("String", "PATCH_AUTHOR_URL", "\"https://github.com/Burhanverse\"")
        buildConfigField(
            "String",
            "PATCH_REPOSITORY_URL",
            "\"https://github.com/Burhanverse/shotgun-patches\""
        )
